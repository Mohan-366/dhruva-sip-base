...
package com.cisco.dsb.proxy.util.log.event;

import static com.cisco.dsb.proxy.util.log.event.Event.DIRECTION.OUT;

import com.cisco.dsb.proxy.util.log.DhruvaLoggerFactory;
import com.cisco.dsb.proxy.util.log.Logger;
import com.cisco.dsb.sip.stack.dto.BindingInfo;
import com.cisco.dsb.util.ObfuscateUtil;
