...
import com.cisco.dsb.util.log.event.Event.ErrorType;
import com.cisco.dsb.util.log.event.Event.EventSubType;
import com.cisco.dsb.util.log.event.Event.EventType;
