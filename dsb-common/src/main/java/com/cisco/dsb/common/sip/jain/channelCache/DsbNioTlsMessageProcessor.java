...
@CustomLog
public class DsbNioTlsMessageProcessor extends NioTlsMessageProcessor
   ...
   */
  public DsbNioTlsMessageProcessor(
  ...
  public void start() throws IOException {
    logger.info("TLS nio message processor thread for stack {} starting", getStackName());
    try {
      super.start();
  ...
  protected synchronized void remove(ConnectionOrientedMessageChannel messageChannel) {
    ...
    logger.debug("Connection removed from tls nio message processor");
  }
