        ...
        if (controllerConfig.isStateful()) {
           ...
           // DsSipHeaderList recordRouteHeaders = request.getHeaders(DsSipRecordRouteHeader.sID);
            ...
            if (recordRouteHeaders == null) {
                ...
                RecordRouteList recordRouteHeadersClone = (RecordRouteList) request.getRecordRouteHeaders().clone();
...
//                }
    ...
    protected void retransmit200()
            throws InvalidStateException, DestinationUnreachableException, DhruvaException, IOException, SipException, InvalidArgumentException {
    ...
    // REDDY_RR_CHANGE
    private void setRecordRouteInterfaceStateful(SIPMessage msg) throws DhruvaException, ParseException {
...
//        DsTokenSipDictionary encode = msg.shouldEncode();
    ...
    private void setRRHelper(
            SIPMessage msg, SipURI currentRRURL, boolean compress) throws ParseException {
        ...
        if (currentRRURL != null) {
            ...
            currentRRURLHost = com.cisco.dhruva.sip.hostPort.HostPortUtil.reverseHostInfoToLocalIp(currentRRURL);
            ...
            if (name != null) {
                ...
                currentRRURL.setHost(com.cisco.dhruva.sip.hostPort.HostPortUtil.convertLocalIpToHostInfo(RRUrl));
    ...
    private void setRecordRouteInterfaceStateless(SIPMessage msg) throws DhruvaException, ParseException {
