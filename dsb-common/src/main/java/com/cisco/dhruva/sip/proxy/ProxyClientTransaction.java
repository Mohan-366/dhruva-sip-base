...
public class ProxyClientTransaction {
        ...
        if ((getState() == STATE_REQUEST_SENT || getState() == STATE_PROV_RECVD)
            ...
            try {
                ...
                if (this.branch != null) {
                    ...
                    //TODO DSB
                    ClientTransaction cancelTransaction = sipTransportProvider.getNewClientTransaction(cancelRequest);
    ...
    /** sends an ACK */
    protected void ack()
            throws DhruvaException, IOException, UnknownHostException, InvalidStateException, SipException, InvalidArgumentException {
