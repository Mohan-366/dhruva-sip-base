...
public class ProxySendMessage {
    ...
    public static CompletableFuture<Void> sendResponse(int responseID, SipProvider sipProvider, ServerTransaction serverTransaction, SIPRequest request) {
    ...
    public static CompletableFuture<Void> sendRequest(SipProvider provider, SIPClientTransaction transaction, SIPRequest request) {
