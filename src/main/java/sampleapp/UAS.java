...
public class UAS implements SipListener {
  ...
  public void processAck(RequestEvent requestEvent,
    ...
    try {
      System.out.println("UAS: got an ACK! ");
  ...
  public void processInvite(RequestEvent requestEvent,
    ...
    Request request = requestEvent.getRequest();
    try {
      System.out.println("UAS: got an Invite sending Trying");
      // System.out.println("UAS: " + request);
  ...
  private void sendInviteOK() {
    try {
      if (inviteTid.getState() != TransactionState.COMPLETED) {
        System.out.println("UAS: Dialog state before 200: "
          + inviteTid.getDialog().getState());
        inviteTid.sendResponse(okResponse);
        System.out.println("UAS: Dialog state after 200: "
          + inviteTid.getDialog().getState());
      }
  ...
  public void processBye(RequestEvent requestEvent,
    ...
    try {
      System.out.println("UAS:  got a bye sending OK.");
  ...
  public void processCancel(RequestEvent requestEvent,
    ...
    Request request = requestEvent.getRequest();
    try {
      System.out.println("UAS:  got a cancel.");
      if (serverTransactionId == null) {
        System.out.println("UAS:  null tid.");
        return;
      }
      Response response = messageFactory.createResponse(200, request);
      serverTransactionId.sendResponse(response);
  ...
  public void init() {
    ...
    try {
      ...
      ListeningPoint lp = sipStack.createListeningPoint("127.0.0.1", // 5070 UDP -> UAS LP
        myPort, "udp");
