...
public class UAC implements SipListener {
  ...
  public void processBye(Request request,
    ...
    try {
      System.out.println("UAC:  got a bye .");
      if (serverTransactionId == null) {
        System.out.println("UAC:  null TID.");
        return;
      }
      ...
      System.out.println("UAC:  Sending OK.");
      System.out.println("Dialog State = " + dialog.getState());
  ...
  public void processResponse(ResponseEvent responseReceivedEvent) {
    ...
    if ( sampleapp.UAS.callerSendsBye && !byeTaskRunning) {
      byeTaskRunning = true;
  ...
  public void init() {
    ...
    properties.setProperty("javax.sip.STACK_NAME", "UAC");
