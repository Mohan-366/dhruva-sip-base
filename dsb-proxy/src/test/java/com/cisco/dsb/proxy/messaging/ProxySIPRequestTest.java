...
public class ProxySIPRequestTest {
    ...
    public void testProxy1() throws ExecutionException, InterruptedException {
        ...
        ProxySIPRequest proxySIPRequest = new ProxySIPRequest(executionContext, provider, request, serverTransaction);
        ...
        CompletableFuture<ProxySIPResponse> responseCompletableFuture =
    ...
    @Test(description = "proxyInterface not set, expect runtime exception", expectedExceptions = RuntimeException.class)
    ...
    public void testConstructor() {
        ProxyInterface proxyInterface = mock(ProxyInterface.class);
        ProxySIPRequest proxySIPRequest1 = new ProxySIPRequest(executionContext, provider, request, serverTransaction);
