...
public class ProxySIPResponseTest {
  ...
  @Test(
      description =
          "proxyInterface is not set in proxyResponse, invoking proxy() api should throw exception",
      expectedExceptions = RuntimeException.class)
  public void testProxyResponse1() {
    ProxySIPResponse proxySIPResponse =
        new ProxySIPResponse(executionContext, provider, response, clientTransaction);
